...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Algos</a>
    ...
    <section class="features" id="features">
      <div class="container">
        <div class="section-heading text-center">
          ...
          <p class="text-muted">Check out what we can offer!</p>
          <hr>
        </div>
        <div class="row">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="feature-item">
                    ...
                    <h3>Music</h3>
                    <p class="text-muted">Hundres of songs are waiting for you here!</p>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="feature-item">
                   <i class="fas fa-apple-alt"></i>
                    <h3>Diet</h3>
                    <p class="text-muted">A nice and easy diet to help you!</p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-6">
                  <div class="feature-item">
                    ...
                    <p class="text-muted">Little physical exercise for your body and mental health!</p>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="feature-item">
                    ...
                    <p class="text-muted">Fun and tricky mind games!</p>
                  </div>
                </div>
              </div>
            </div>
